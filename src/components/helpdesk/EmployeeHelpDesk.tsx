...
export default function EmployeeHelpDesk() {
  ...
  const columnDefs = [
    { field: "ticketId", headerName: "Ticket ID", flex: 1 },
    {
      ...
      flex: 1.5,
      cellRenderer: (params: { value: SubmittedBy }) =>
        `${params.value.employeeName} (${params.value.role})`,
    },
    {
      field: "status",
      headerName: "Status",
      ...
      cellRenderer: (params: { value: string }) => (
        <Tag color={getStatusColor(params.value)}>
  ...
  const fetchTickets = useCallback(async () => {
    try {
      ...
      const filteredTickets = tickets.filter(
        (ticket: Query) =>
          ticket.submittedBy.employeeName === user?.employeeName
      );
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="bg-gray-50 p-4 rounded mb-6">
            ...
            <form
              ...
              className="max-w-2xl grid grid-cols-1 md:grid-cols-2 gap-4"
            >
          ...
          <div className="bg-white rounded">
            ...
            <div
              className="ag-theme-alpine rounded overflow-hidden"
              ...
              <div className="p-4 space-y-3">
                ...
                <div className="border-t pt-3">
                  ...
                  <p className="text-gray-700">
                    {selectedQuery.submittedBy.employeeName} (
                    {selectedQuery.submittedBy.role})
                  </p>
                </div>
                <div className="border-t pt-3">
                  <p className="text-sm text-gray-500 mb-1">Admin Notes</p>
                  <p className="text-gray-700">
                    {selectedQuery.adminNotes || "No notes available"}
                  </p>
                </div>
